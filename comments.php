 ...
 * handled by a callback to pine_comment() which is
...
<div id="comments" class="row">
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'pine' ); ?></p>
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See pine_comment() in inc/functions/comments.php for more.
				 */
				wp_list_comments( array( 'callback' => 'pine_comment' ) );
			?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'pine' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'pine' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'pine' ) ); ?></div>
		</nav>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'pine' ); ?></p>
	<?php endif; ?>
